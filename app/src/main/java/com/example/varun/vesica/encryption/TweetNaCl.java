...
package com.example.varun.vesica.encryption;

import com.example.varun.vesica.encryption.exceptions.AuthException;
import com.example.varun.vesica.encryption.exceptions.DecryptException;
import com.example.varun.vesica.encryption.exceptions.EncryptException;
import com.example.varun.vesica.encryption.exceptions.HashException;
import com.example.varun.vesica.encryption.exceptions.KeyPairException;
import com.example.varun.vesica.encryption.exceptions.SignException;
import com.example.varun.vesica.encryption.exceptions.VerifyException;
...
public class TweetNaCl {
    ...
    private static native int jniCryptoBoxKeyPair(byte[] publicKey, byte[] secretKey);
     ...
     */
    public static KeyPair cryptoBoxKeyPair() throws KeyPairException {
